...
```cpp title="resources/procedural-programming/дз 4 защищено/4.1 main.cpp"
#include <iostream>
#include <fstream>
using namespace std;
...
```cpp title="resources/procedural-programming/дз 4 защищено/4.2 main.cpp"
#include <iostream>
#include <cmath>
...
```cpp title="resources/procedural-programming/дз 4 защищено/4.3 main.cpp"
#include <iostream>
#include <cmath>
using namespace std;
void prog1() {
...
```cpp title="resources/procedural-programming/дз 4 защищено/4.4 main.cpp"
#include <iostream>
#include <cmath>
using namespace std;
int main() {
...
```cpp title="resources/procedural-programming/дз 4 защищено/4.5 main ura.cpp"
#include <iostream>
#include <cmath>
using namespace std;
int main()
...
```cpp title="resources/procedural-programming/дз 4 защищено/4.6 URA BLYAT.cpp"
#include <iostream>
#include <cmath>
using namespace std;
int cf(char x)
...
```cpp title="resources/procedural-programming/дз 4 защищено/4.7 pobeda.cpp"
#include <iostream>
using namespace std;
int s = 0;
int f()
...
```cpp title="resources/procedural-programming/дз 4 защищено/4.8 dodel.cpp"
#include <iostream>
#include <stdlib.h>
#include <stdio.h>
#include <algorithm>
...
```cpp title="resources/procedural-programming/дз 4 защищено/4.9.cpp"
#include <iostream>
#include <cmath>
#include <string>
using namespace std;
