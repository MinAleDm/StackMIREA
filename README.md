...
- Главная страница с семантическим поиском, блоком авторов и разработчиков, правилами публикации и быстрыми переходами.
...
- Дополнительная страница `/authors` с полным списком авторов публикаций и участников команды разработки.
