...
Моделирование игры через очереди и коллекции. Документация собрана по исходному коду этой практики.
...
- `Task12/Drunkard.java`

#### `Task12/Drunkard.java`

```java title="Task12/Drunkard.java"
package Task12;
...
Task 12 — Игра Пьяница документирует реальное решение из исходного кода.
