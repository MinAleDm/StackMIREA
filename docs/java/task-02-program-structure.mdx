...
Точка входа и минимальная структура Java-приложения. Документация собрана по исходному коду этой практики.
...
Task 2 — Структура программы документирует реальное решение из исходного кода.
