...
```cpp title="resources/procedural-programming/dz 3 zashisheno/3.1 verno.cpp"
#include <iostream>
#include <math.h>
using namespace std;
...
```cpp title="resources/procedural-programming/dz 3 zashisheno/3.2 verno.cpp"
#include <iostream>
#include <math.h>
using namespace std;
...
```cpp title="resources/procedural-programming/dz 3 zashisheno/3.3 main.cpp"
#include <iostream>
#include <fstream>
using namespace std;
...
```cpp title="resources/procedural-programming/dz 3 zashisheno/3.4 main.cpp"
#include <iostream>
#include <fstream>
using namespace std;
...
```cpp title="resources/procedural-programming/dz 3 zashisheno/3.5 main.cpp"
#include <iostream>
#include <string>
#include <algorithm>
using namespace std;
