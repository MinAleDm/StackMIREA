...
```cpp title="resources/procedural-programming/dz 5/51 DONE.cpp"
#include <iostream>
#include <algorithm>
using namespace std;
int main(){
...
```cpp title="resources/procedural-programming/dz 5/52 DONE.cpp"
#include <iostream>
#include <algorithm>
using namespace std;
int main() {
...
```cpp title="resources/procedural-programming/dz 5/5.3.cpp"
#include <iostream>
#include <fstream>
#include <conio.h>
using namespace std;
...
```cpp title="resources/procedural-programming/dz 5/5.6.cpp"
#include <iostream>
#include <vector>
using namespace std;
