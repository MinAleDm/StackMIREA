...
```cpp title="resources/procedural-programming/дз 2 защищено/конус main правильный.cpp"
#include <iostream>
#include <math.h>
#include <cmath>
using namespace std;
...
```cpp title="resources/procedural-programming/дз 2 защищено/разветвление.cpp"
#include <iostream>
#include <cmath>
using namespace std;
int main() {
...
```cpp title="resources/procedural-programming/дз 2 защищено/функция main.cpp"
#include <iostream>
#include <math.h>
#include <cmath>
using namespace std;
...
```cpp title="resources/procedural-programming/дз 2 защищено/порядок main m.cpp"
#include <iostream>
#include <math.h>
#include <cmath>
using namespace std;
...
```cpp title="resources/procedural-programming/дз 2 защищено/табуляциян.cpp"
#include <stdlib.h>
#include <math.h>
#include <iostream>
using namespace std;
